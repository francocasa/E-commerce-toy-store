function PrivacyPolicyPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        En Juguetitos, valoramos tu privacidad y nos comprometemos a proteger tu
        información personal. Esta política explica cómo recopilamos, usamos y
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          Enviarte promociones y actualizaciones, si has dado tu consentimiento.
        </li>
      </ul>
      ...
      <p className="mb-4">
        ...
        personal. Sin embargo, ningún método de transmisión por Internet es 100%
        seguro.
      </p>
      ...
      <p className="mb-4">
        ...
        notificaremos sobre cualquier cambio mediante un aviso en nuestro sitio.
      </p>
