  ...
  return (
    <section className="py-10">
      <div className="flex justify-between items-center mb-5">
        ...
        <a href="/ProductsPage" className="text-blue-600 hover:underline">Ver todo &rarr;</a>
      </div>
      <div className="relative">
        ...
        >
          ...
          {products.map(product => (
            <div key={product.id} className="min-w-[200px] bg-white shadow-md p-4 rounded-md">
              ...
              <a href="/product-detail" className="text-blue-600 hover:underline">Ver producto</a>
            </div>
          ))}
        </div>
